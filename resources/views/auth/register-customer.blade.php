                    ...
                    <form class="space-y-6" action="login" method="POST">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="email" type="email" value="{{ old('email') }}" required placeholder="Masukkan email">
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                class="focus:ring-primary focus:border-primary w-full rounded-lg border border-gray-200 px-4 py-3 outline-none transition focus:ring-2"
                                id="password" type="password" placeholder="Masukkan kata sandi anda" required>
                        </div>

                        <!-- Links -->
                        <div class="flex justify-center text-sm">
                            <a class="text-info hover:underline" href="#">Belum punya akun? klik disini</a>
                        </div>
