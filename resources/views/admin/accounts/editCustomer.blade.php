            ...
            <div class="overflow-hidden rounded-lg bg-white shadow-xl">
                ...
                <div class="bg-green-600 px-8 py-8">
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            ...
                            <p class="text-lg text-green-100">Perbarui informasi profil customer</p>
                        </div>
                    </div>
                </div>
                ...
                <form class="px-10 py-10" action="{{ route('admin.accounts.update') }}" method="POST">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label class="mb-2 block text-base font-medium text-gray-700" for="nik">NIK</label>
                                <input
                                    class="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-3 text-base shadow-sm focus:border-green-500 focus:ring-green-500"
                                    id="nik" name="nik" type="text" value="{{ old('nik', $customer->nik) }}"
                            ...
                            <div>
                                <label class="mb-2 block text-base font-medium text-gray-700" for="farm_area">Luas Lahan
                                    (hektar)</label>
                                <input
                                    class="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-3 text-base shadow-sm focus:border-green-500 focus:ring-green-500"
                                    id="farm_area" name="farm_area" type="number"
                                    value="{{ old('farm_area', $customer->farm_area) }}" step="0.01" required>
                                @error('farm_area')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
